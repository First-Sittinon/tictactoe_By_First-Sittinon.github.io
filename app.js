    ...
    let elementId = myId.id;
        ...
        //     let unArr1 = Array.from(set1);
        //     let unArr2 = Array.from(set2);

        //     unArr1.sort();
        //     unArr2.sort();

        //     return JSON.stringify(unArr1) === JSON.stringify(unArr2);
        // };

            // if (row_first.some(index) === collecIdX.some(index)) {
            //     console.log('ตรงกัน');
            // } else {
        ...
        // function checkWinner() {
        //     for (let i = 0; i < 3; i++){
        //         if (collecIdX[i * 3].textContent && collecIdX[i * 3].textContent === collecIdX[i * 3 + 1].textContent
        //             && collecIdX[i * 3].textContent === collecIdX[i * 3 + 2].textContent) {
        //                 return true;
        //             }
        //     }
        // };   
